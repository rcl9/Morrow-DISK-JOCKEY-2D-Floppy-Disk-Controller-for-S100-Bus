...
- Design and build my own 50pin-to-36pin Shugart adapter board. My version allowed for both the HxC emulator to be attached to the Morrow DJ2D card *as well as* another set of 8" floppy drives. I'd eventually test this as a working solution. I am providing my pin mapping in this [Excel spreadsheet](</50pin-to-36pin Shugart adapter board/RCL9's Shugart 34 pin to 50 pin mapping.xlsx>). I am not providing a schematic since the pin mappings are pretty straightforward from my Excel spreadsheet. At most I added two jumper headers to the board: (1) one sets "2-sided" mode which grounds out pin 10 of the 50-pin connector to the FDC (/FD2D), and (2) a routing from pin 34 (1 = Disk Change or 0 = /Ready) of the 36-pin connector to either pin 22 (/Ready) or pin 12 (/DC) of the 50 pin connector; I have this jumped from pin 34 (/Ready) to pin 22 (/Ready).
